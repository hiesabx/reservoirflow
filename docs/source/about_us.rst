...
We are *Hiesab*; an international startup company founded in 2024 based in  Libya (so far) specialized in advanced data analytics, scientific computing, and automation with a mission to accelerate R&D for AI applications and data solutions in different fields including Science, Engineering, and Education. We plan to be a strategic AI and data partner for universities and companies worldwide. Ultimately, we strive for the highest levels of precision in computing and analytics, all in the pursuit of promoting justice in transactions, management, and governance.
...
We believe that employing scientific machine learning to study mathematical and physical problems is the optimal approach to developing more efficient AI algorithms. As we gain experience in this field, we draw a direct analogy by creating language models constrained by knowledge, much like how mathematical models are constrained by physics. This approach not only enhances efficiency but also ensures greater stability and higher accuracy.


Our View on AI, AGI, Generative AI, AI Risks, and AI Regulations
----------------------------------------------------------------

We do not subscribe to the hype surrounding AI where the term is often misused for marketing purposes. Our vision centers on making intelligent decisions through the use of specialized machine learning models that work together to optimize specific processes. By automating intelligent decision-making for particular tasks, we still refer to our approach as AI, or more specifically Weak (or narrow) AI. However, it is essential to distinguish this from Strong (or general) AI, also known as Artificial General Intelligence (AGI), where the goal is to create machines with the ability to understand, learn, and apply knowledge in a way that is indistinguishable from human intelligence. Our focus remains on task-specific intelligence, ensuring practical and efficient solutions rather than pursuing the broader, more generalized aspirations of AGI. However, AGI will still be a research topic for us, as we explore the potential and boundaries of intelligent systems.

We see generative AI as a means to create intelligent machines that collaborate closely with humans to boost productivity and efficiency. We are not only embracing a culture of working alongside intelligent machines but also aiming to develop them in a way that blends efficiency with innovation. By leveraging generative AI in our research and development, we aim to constrain our language models with knowledge based on science and engineering the same way we constrain our mathematical models with differential equations based on physics.

We understand that AI, like many other technologies, has dual-use potential. However, we believe that the benefits of AI significantly outweigh the risks in many fields such as healthcare, science, and education. Therefore, we focus on harnessing the positive applications of AI while ensuring that risks are addressed and more importantly minimized or eliminated whenever possible.

We believe that AI regulations should follow, rather than precede, AI innovations. This approach allows for the identification and addressing of actual legal gaps, avoiding the pitfalls of unnecessary regulations that could stifle innovation. Premature regulations based on hypothetical problems can create barriers and hinder progress. Moreover, unfounded AI risks could be exploited to manipulate public opinion, resulting in legislation that benefits new businesses based on these exaggerated risks, potentially leading to further exploitation. Having only regulations or only innovations is detrimental to society. Therefore, we advocate for an approach where innovations are balanced by regulations as a following step (and not vice versa), ultimately benefiting society as a whole. We are committed to collaborating with legislative bodies to transparently clarify these risks.
