...
This section is dedicated to research and development (R&D) topics including collaboration with companies, universities, or individuals. This tool is still far from perfect and the main objective of having this R&D section is to continue developing this tool to reach a production level (i.e., a stable python library with most of the functionalities and features used in Reservoir Simulation).
